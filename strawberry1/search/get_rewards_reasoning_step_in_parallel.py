...
def main():
    ...
    if not all_file_exists:
        ...
        elif test_prm == "mmlu_heo_augs_llama_lora":
            from v5_llama_lora import test_prm_dual
            prm = test_prm_dual(
                aggregation="full", 
                model_id="Daewon0808/mmlu_heo_augs_llama_lora"
            )
        else:
