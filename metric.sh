...
OUTPUT_DIR="results_backup/full_precision_results/transformed_mmlupro_reward_results"
METRIC_SAVE_DIR="results_backup/results_by_category"

PIDS=()
for MODEL in "mmlu_math_noaugs_llama_lora" "mmlu_small_noaugs_llama_lora" "mmlu_noaugs_llamabase_lora" "mmlu_noaugs_llama_fulltune" "mmlu_noaugs_qwen_lora"; do
    echo "running $MODEL"
